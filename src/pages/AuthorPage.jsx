...
const AuthorPage = () => {
    ...
    const fetchAuthorData = async () => {
      try {
        ...
        const [authorData, articlesData] = await Promise.all([
          ...
          authorAPI.getArticlesByAuthor(id, 1, 12),
        ]);
  ...
  const loadMoreArticles = async () => {
    try {
      ...
      const newArticles = await authorAPI.getArticlesByAuthor(id, nextPage, 12);
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
        <div className="flex flex-col md:flex-row items-start md:items-center">
          <img
            src={author.avatar}
            alt={author.name}
            className="w-24 h-24 rounded-full mr-0 md:mr-6 mb-4 md:mb-0"
          />
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-6 text-sm text-gray-500">
              ...
              <div className="flex items-center">
                ...
                <span>Member since {formatDistanceToNow(new Date(author.joinedAt), { addSuffix: true })}</span>
              </div>
              {author.totalViews && (
                <div>
...
// Author Article Card Component
const AuthorArticleCard = ({ article }) => {
  return (
